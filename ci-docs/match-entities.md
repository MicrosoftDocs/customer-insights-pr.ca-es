...
Si heu enriquit entitats al nivell font de dades per ajudar a millorar els resultats de la unificació, seleccioneu-les. Per obtenir més informació, vegeu [Enriquiment per a fonts](data-sources-enrichment.md) de dades. Si heu seleccionat entitats enriquides a la **pàgina Registres duplicats**, no cal que les torneu a seleccionar.
