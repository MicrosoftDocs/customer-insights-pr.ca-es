---
title: Exporta les dades als amfitrions SFTP (previsualització) (conté vídeo)
...
ms.locfileid: "9082759"
---
# <a name="export-data-to-sftp-preview"></a>Exporta les dades a l'SFTP (previsualització)
